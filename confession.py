...
class MessageBox(QtWidgets.QWidget):#继承自父类QtWidgets.QWidget
    ...
    def __init__(self,parent = None): #parent = None代表此QWidget属于最上层的窗口,也就是MainWindows.
        ...
        self.resize(800,1000)# 设置窗体大小，本行可有可无。
        ...
        self.setWindowIcon(QIcon('F:/cc/icon.png')) # 调用QIcon构造函数时，我们需要提供要显示的图标的路径(相对或绝对路径)。同时注意：使用QIcon类型必须导入此模块from PyQt5.QtGui import QIcon
        ...
        self.window_pale.setBrush(self.backgroundRole(),QtGui.QBrush(QtGui.QPixmap("F:/cc/ltx.jpg")))#打开图片
    ...
    def center(self):
        ...
        #idgets.QDesktopWidget().screenGeometry()中QDesktopWidget()也有括号
